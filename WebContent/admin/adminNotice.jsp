        ...
        <table class="table table-striped table-sm">
          <thead>
			...
			<c:if test="${noticeList != null}">
				...
				<c:url var="url4" value="/not/noticeContent.do">
					...
					<tr align="center" onclick="location.href='${url4}'"> 
						...
						<td>${notice.date }</td>
						<td>${notice.count }</td>
						<td><a href="noticeAdmindel.do?num=${notice.num}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
